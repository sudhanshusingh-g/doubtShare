...
export default function Home() {
  return (
    <section className="h-5/6  text-center xl:h-screen flex items-center justify-center">
      <div className="px-4 py-8">
        <h2 className="text-2xl font-bold tracking-tight text-gray-800 xl:text-6xl">
        Real-Time Doubt Solving Platform
        </h2>
        <p className="mt-4 block max-w-4xl text-gray-500 w-3/4 mx-auto text-justify">
        DoubtShare is an interactive real-time doubt solving platform designed to assist students with their academic queries. 
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Accusamus quod laudantium expedita, ratione aliquam iste blanditiis minima est numquam autem atque eveniet aperiam deleniti natus corporis nobis mollitia aut inventore?
        </p>
        <div className="mt-6">
          <a
            href="#"
            className="inline-flex w-full items-center justify-center overflow-hidden rounded-lg bg-gray-900 px-2 py-4 text-sm text-white shadow transition-colors duration-300 hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80 sm:mx-2 sm:w-auto"
          >
            <svg
          ...
          <a
            href="#"
            className="mt-4 inline-flex w-full items-center justify-center overflow-hidden rounded-lg bg-blue-600 px-4 py-4 text-sm text-white shadow transition-colors duration-300 hover:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80 sm:mx-2 sm:mt-0 sm:w-auto"
          >
            <svg
              className="mx-2 h-5 w-5 fill-current"
